...
# date: 2026-01
# description: Class for the GenConviTVAE detector
...
@DETECTOR.register_module(module_name='genconvitvae')
class GenConVitVAEDetector(AbstractDetector):
    ...
    def forward(self, data_dict: dict, inference=False) -> dict:
        z = self.encoder(data_dict)
        x_hat = self.decoder(z)

        x1 = self.convnext_backbone(data_dict)
