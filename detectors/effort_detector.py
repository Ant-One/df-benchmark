...
class EffortDetector(nn.Module):
    ...
    def build_backbone(self, config):
        ...
        # ViT-L/14 224*224
        clip_model = CLIPModel.from_pretrained("openai/clip-vit-large-patch14")  # the path of this folder in your disk (download from the above link) -> got it from HuggingFace
