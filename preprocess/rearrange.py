...
def generate_dataset_file(dataset_name, dataset_root_path, output_file_path, compression_level='c23', perturbation = 'end_to_end'):
    ...
    ## roop dataset
    ...
    elif dataset_name == "ConfDF_norm_v2_th":
        subset = "th"
        dataset_path = os.path.join(dataset_root_path, "ConfDF_norm_v2_aligned")
        ...
        for folder in os.scandir(dataset_path):
            if not os.path.isdir(folder):
                ...
                for video_path in os.scandir(os.path.join(dataset_path, folder.name, subset)):
                    if video_path.is_dir():
                        video_name = video_path.name
                        label = 'ConfDF_fake'
                        frame_paths = [os.path.join(video_path, frame.name) for frame in os.scandir(video_path)]
    ...
    elif dataset_name == "ConfDF_norm_v2_th-bb":
        subset = "th-bb"
        dataset_path = os.path.join(dataset_root_path, "ConfDF_norm_v2_aligned")
        dataset_dict[dataset_name] = {'ConfDF_real': {'train': {}, 'test': {}, 'val': {}},
                                'ConfDF_fake': {'train': {}, 'test': {}, 'val': {}}}
    ...
    elif dataset_name == "ConfDF_norm_v2_th-ob":
        subset = "th-ob"
        dataset_path = os.path.join(dataset_root_path, "ConfDF_norm_v2_aligned")
        dataset_dict[dataset_name] = {'ConfDF_real': {'train': {}, 'test': {}, 'val': {}},
                                'ConfDF_fake': {'train': {}, 'test': {}, 'val': {}}}
    ...
    elif dataset_name == "ConfDF_norm_v2_th-m":
        subset = "th"
        dataset_path = os.path.join(dataset_root_path, "ConfDF_norm_v2_aligned")
        dataset_dict[dataset_name] = {'ConfDF_real': {'train': {}, 'test': {}, 'val': {}},
                                'ConfDF_fake': {'train': {}, 'test': {}, 'val': {}}}
    ...
    elif dataset_name == "ConfDF_norm_v2_all":
        dataset_path = os.path.join(dataset_root_path, "ConfDF_norm_v2_aligned")
        dataset_dict[dataset_name] = {'ConfDF_real': {'train': {}, 'test': {}, 'val': {}},
                                'ConfDF_fake': {'train': {}, 'test': {}, 'val': {}}}
        for folder in os.scandir(dataset_path):
            if not os.path.isdir(folder):
                ...
                for subset_path in os.scandir(os.path.join(dataset_path, folder.name)):
                    if subset_path.is_dir():
                        for video_path in os.scandir(os.path.join(dataset_path, folder.name, subset_path.name)):
                            if video_path.is_dir():
                                video_name = video_path.name
                                label = 'ConfDF_fake'
                                frame_paths = [os.path.join(video_path, frame.name) for frame in os.scandir(video_path)]
